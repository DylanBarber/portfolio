...
const AboutMe = () => (
  <div className="container">
    <div className="content">
      ...
      <h1>Dylan Barber</h1>
      <p className="aboutMeText">I am a Full Stack Software Developer in Detroit, Michigan. I have experience in Javascript, Node JS, React JS, Electron JS, test driven development using Chai and Mocha JS, CI/CD, MongoDB and many other technologies.
